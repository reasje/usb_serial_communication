...
import 'usb_serial_communication_platform_interface.dart';

const eventChannelID =
    'id.farellsujanto.flutter_serial_communication.flutter_event_channel';

/// An implementation of [USBSerialCommunicationPlatform] that uses method channels.
class MethodChannelUSBSerialCommunication
    extends USBSerialCommunicationPlatform {
