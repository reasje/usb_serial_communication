...
import 'usb_serial_communication_method_channel.dart';

abstract class USBSerialCommunicationPlatform extends PlatformInterface {
  /// Constructs a FlutterSerialCommunicationPlatform.
  USBSerialCommunicationPlatform() : super(token: _token);

  static final Object _token = Object();

  static USBSerialCommunicationPlatform _instance =
      MethodChannelUSBSerialCommunication();

  /// The default instance of [USBSerialCommunicationPlatform] to use.
  ///
  /// Defaults to [MethodChannelUSBSerialCommunication].
  static USBSerialCommunicationPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [USBSerialCommunicationPlatform] when
  /// they register themselves.
  static set instance(USBSerialCommunicationPlatform instance) {
